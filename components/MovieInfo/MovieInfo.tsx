...
type Props = {
  ...
  backgroundImgUrl: string | StaticImageData;
  title: string;
  summary: string;
  rating: number;
  directors: Crew[];
...
const MovieInfo = ({ thumbUrl, backgroundImgUrl, title, summary, rating, directors, time, budget, revenue }: Props) => (
  <div className='relative w-full h-auto p-4'>
    <div className='relative h-full min-h-128 flex flex-col md:flex-row max-w-7xl p-4 m-auto z-10 rounded-xl bg-zinc-900 bg-opacity-90'>
      ...
      <div className='text-white px-0 py-4 md:py-0 text-center md:text-left md:px-8 w-full md:w-2/3'>
        <h2 className='text-2xl md:text-4xl font-bold pb-4'>{title}</h2>
